...
#     This template is designed to dynamically construct a prompt that includes
#     several examples of a task. This helps language models understand complex
#     instructions or specific output formats by learning from the provided examples
#     ("shots") within the context of the prompt itself.
#     """
...
#         Args:
#             examples (List[Dict[str, str]]): A list of dictionaries, where each
#                 dictionary is an example with keys matching the variables in
#                 `example_prompt`.
#             example_prompt (PromptTemplate): The template used to format each
#                 individual example.
#             suffix (str): The final part of the prompt, which typically contains
#                 the placeholders for the new input.
#             input_variables (List[str]): All variables that the final prompt will
#                 expect.
#             prefix (str): A string to be added at the very beginning of the prompt.
#             example_separator (str): The string used to join the formatted examples.
#         """
#         super().__init__(input_variables)
#         self.examples = examples
#         self.example_prompt = example_prompt
