...
from minichain.pipecat.observers.base_observer import BaseObserver, FramePushed
from minichain.pipecat.observers.turn_tracking_observer import TurnTrackingObserver
from minichain.pipecat.utils.tracing.conversation_context_provider import ConversationContextProvider
from minichain.pipecat.utils.tracing.setup import is_tracing_available
from minichain.pipecat.utils.tracing.turn_context_provider import TurnContextProvider
...
class TurnTraceObserver(BaseObserver):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._tracer = trace.get_tracer("pipecat.turn") if is_tracing_available() else None # type: ignore
