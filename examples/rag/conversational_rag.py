...
knowledge_texts = [
    "The Minichain library's core principle is transparency and modularity. "
    ...
    "He created the Minichain library as part of his internship project.",
    
    "IST Networks is the company where Fady is doing his internship. "
    "Engineer Amin is his supervisor who assigned the Minichain development task."
]
...
For knowledge questions (about Minichain, Fady, IST Networks, etc.), use the provided context.
